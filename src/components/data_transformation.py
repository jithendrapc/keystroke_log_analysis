...
class DataTransformation:
    ...
    def  initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            input_feature_train_df = train_df.drop(columns=['score'],axis=1)
            target_feature_train_df = train_df['score']
            
            input_feature_test_df = test_df.drop(columns=["score"],axis=1)
            target_feature_test_df = test_df['score']
